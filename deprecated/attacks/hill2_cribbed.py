...
for offset in range(0, hillDimension):
	plainPreChecks.append(plaintext[plainStart-2+offset:plainStart+offset])
	cipherPreChecks.append(ciphertext[plainStart-2+offset:plainStart+offset])
	...
	plainPostChecks.append(plaintext[plainStart+length+offset:plainStart+length+offset+2])
	cipherPostChecks.append(ciphertext[plainStart+length+offset:plainStart+length+offset+2])

# Set up the output file.
outputFile = open("hill2_cribbed.output", 'w', 1)
